...
namespace Acme.BookStore.Web
{
    ...
    public class BookStoreWebModule : AbpModule
    {
        ...
        private void ConfigureAuthentication(ServiceConfigurationContext context, IConfiguration configuration)
        {
            ...
            {
                options.Authority = configuration["AzureAd:InstancePath"] + "oauth2/v2.0/";
                ...
                options.MetadataAddress = configuration["AzureAd:InstancePath"] + "v2.0/.well-known/openid-configuration?p=" + configuration["AzureAd:LoginFlowName"];
